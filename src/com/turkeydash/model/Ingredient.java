...
public enum Ingredient {
    STUFFING("stuffing", 5, Category.DRY_GOODS), CRANBERRIES, BEER, HONEY, PINEAPPLE,CLOVES, FLOUR, EGG, MILK, CREAM_OF_MUSHROOM, MARSHMALLOWS, BROWN_SUGAR,
    ORANGE_JUICE, MAYONNAISE, BUTTER, SAVORY_SEASONING, CHEESE, BREADCRUMBS, OLIVE_OIL, GARLIC, NUTMEG, CINNAMON, APPLES,
    ;
